...
*Stage 3 completo con este ítem. `src/impresion/` es un módulo nuevo, no
estaba en la lista de placeholders original del scaffold — ver su
`README.md` para el porqué.*

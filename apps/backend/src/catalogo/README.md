...
Estado: **Stage 2 de TASKS.md en curso** — dominio y casos de uso
(`CrearProducto`, `CrearVariante`) con sus tests, como plantilla del patrón
a repetir en el resto de los módulos.
